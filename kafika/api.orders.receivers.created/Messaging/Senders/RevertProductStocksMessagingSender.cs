...
{
    public class RevertProductStocksMessagingSender : IRevertProductStocksMessagingSender
    {
        private readonly string _hostname;
        private readonly string _queueName;
        private IConnection _connection;

        public RevertProductStocksMessagingSender(IOptions<RabbitMqConfiguration> rabbitMqOptions)
        {
