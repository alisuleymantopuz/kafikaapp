...
{
    public class OrderShipperMessagingSender : IOrderShipperMessagingSender
    {
        private readonly string _hostname;
        private readonly string _queueName;
        private IConnection _connection;

        public OrderShipperMessagingSender(IOptions<RabbitMqConfiguration> rabbitMqOptions)
        {
        ...
        public void SendShipperAssignedOrder(Order order)
        {
            if (ConnectionExists())
            {
