...
{
    public class OrderDeliveryMessagingSender : IOrderDeliveryMessagingSender
    {
        private readonly string _hostname;
        private readonly string _queueName;
        private IConnection _connection;

        public OrderDeliveryMessagingSender(IOptions<RabbitMqConfiguration> rabbitMqOptions)
        {
        ...
        public void SendDeliveryOrder(Order order)
        {
            if (ConnectionExists())
            {
