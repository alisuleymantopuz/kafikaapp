...
{
    public class OrderProductsUpdateService : IOrderProductsUpdateService
    {
        private readonly IServiceProvider _serviceProvider;
        public OrderProductsUpdateService(IServiceProvider serviceProvider)
        {
            _serviceProvider = serviceProvider;
        }

        public void UpdateProducts(Guid orderId, string notes = "")
        {
